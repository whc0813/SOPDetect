...
CREATE TABLE IF NOT EXISTS sop_steps (
  ...
  min_duration_sec DECIMAL(8,3) NULL,
  max_duration_sec DECIMAL(8,3) NULL,
...
CREATE TABLE IF NOT EXISTS execution_step_results (
  ...
  min_duration_sec_snapshot DECIMAL(8,3) NULL,
  max_duration_sec_snapshot DECIMAL(8,3) NULL,
  evidence TEXT NULL,
  created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
